...
export function buildFolderTree(folders: FolderSource[]): FolderTreeNode[] {
	const nodes = new Map<string, FolderTreeNode>();
	for (const folder of folders) nodes.set(folder.id, { ...folder, children: [], depth: 0 });
