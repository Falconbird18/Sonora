const COMPOSER_PORTRAITS: Record<string, string> = {
  ...
  chopin: 'https://upload.wikimedia.org/wikipedia/commons/e/e8/Frederic_Chopin_photo.jpeg',
  brahms: 'https://upload.wikimedia.org/wikipedia/commons/1/15/JohannesBrahms.jpg',
  tchaikovsky: 'https://upload.wikimedia.org/wikipedia/commons/d/d4/Tchaikovsky_by_Reutlinger.jpg',
