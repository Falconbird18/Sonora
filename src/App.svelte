...
<main class="app-shell">
	{#if activeScore}
		<div class="view-transition"><ScoreViewer score={activeScore} onBack={() => (activeScore = null)} /></div>
	{:else}
		<div class="view-transition"><LibraryView onSelectScore={(score) => (activeScore = score)} /></div>
	{/if}
</main>
